...
export const L_SIZE_SCREEN = 1280;
export const M_SIZE_SCREEN = 1163;
export const S_SIZE_SCREEN = 672;

export const INIT_FOR_L_SCREEN = 12;
export const INIT_FOR_M_SCREEN = 8;
export const INIT_FOR_S_SCREEN = 5;

export const INC_FOR_L_SCREEN = 3;
export const INC_FOR_M_SCREEN = 2;
export const INC_FOR_S_SCREEN = 2;
